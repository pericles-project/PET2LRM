 ...
 */
public class LRM_static_schema {
	/**
	 * <p>
	...
	public static final OntProperty birthTime = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#birthTime");

	public static final OntProperty deathTime = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#deathTime");

	/**
	 * <p>
	 * This property allows defining formally a resource; note that the range of
	 * this property is open
	 * </p>
	 */
	public static final OntProperty definition = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#definition");
	 ...
	 * </p>
	 */
	public static final OntProperty durationTime = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#durationTime");
	 ...
	 * </p>
	 */
	public static final OntProperty fingerprint = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#fingerprint");

	public static final OntProperty from = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#from");

	public static final OntProperty hasMember = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#hasMember");

	public static final OntProperty hasPart = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#hasPart");
	...
	/**
	 * <p>
	 * Designates the lrm:Plan instance that characterizes how the change of a
	 * dependee(s) impacts the depending resource(s): what must be done if the
	 * dependency is activated
	 * </p>
	 */
	public static final OntProperty impact = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#impact");
	...
	/**
	 * <p>
	 * This property allows describing, formally or not, the intented usage of
	 * the resource (answer to the WHY question)
	 * </p>
	 */
	public static final OntProperty intention = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#intention");

	public static final OntProperty isMemberOf = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#isMemberOf");

	public static final OntProperty lifeTime = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#lifeTime");
	...
	public static final OntProperty location = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#location");

	public static final OntProperty partOf = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#partOf");

	/**
	 * <p>
	 * Designates the lrm:Plan instance that characterizes the conditions for
	 * the change of dependee(s) to trigger a change propagation to depending
	 * resources.
	 * </p>
	 */
	public static final OntProperty precondition = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#precondition");
	 ...
	 * </p>
	 */
	public static final OntProperty realizedAs = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#realizedAs");

	public static final OntProperty realizedBy = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#realizedBy");

	/**
	 * <p>
	 * This property describes, formally or not, the resource itself (answer to
	 ...
	 * </p>
	 */
	public static final OntProperty url = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#url");

	public static final OntClass AbstractResource = m_model
			.createClass("http://xrce.xerox.com/LRM#AbstractResource");
	...
	public static final OntClass ConcreteResource = m_model
			.createClass("http://xrce.xerox.com/LRM#ConcreteResource");
	...
	/**
	 * <p>
	 * A dependency, according to the LRM model, is oriented, and may relate at
	 * least one lrm:Resource instance to at least one lrm:Resource instance.
	 ...
	 * </p>
	 */
	public static final OntClass Dependency = m_model
			.createClass("http://xrce.xerox.com/LRM#Dependency");
	...
	public static final OntClass DigitalSignature = m_model
			.createClass("http://xrce.xerox.com/LRM#DigitalSignature");
	...
	public static final OntClass ExogenousResource = m_model
			.createClass("http://xrce.xerox.com/LRM#ExogenousResource");

	public static final OntClass HumanAgent = m_model
			.createClass("http://xrce.xerox.com/LRM#HumanAgent");
	...
	public static final OntClass ImmutableResource = m_model
			.createClass("http://xrce.xerox.com/LRM#ImmutableResource");
	...
	public static final OntClass Location = m_model
			.createClass("http://xrce.xerox.com/LRM#Location");

	public static final OntClass MutableResource = m_model
			.createClass("http://xrce.xerox.com/LRM#MutableResource");

	public static final OntClass Organization = m_model
			.createClass("http://xrce.xerox.com/LRM#Organization");
	 ...
	 * </p>
	 */
	public static final OntClass Protocol = m_model
			.createClass("http://xrce.xerox.com/LRM#Protocol");
	 ...
	 * changeMutable resources can change
	 * </p>
	 */
	public static final OntClass Resource = m_model
			.createClass("http://xrce.xerox.com/LRM#Resource");

	public static final OntClass SoftwareAgent = m_model
			.createClass("http://xrce.xerox.com/LRM#SoftwareAgent");
	...
	public static final OntProperty describes = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#describes");

	public static final OntProperty realizes = m_model
			.createOntProperty("http://xrce.xerox.com/LRM#realizes");
}
