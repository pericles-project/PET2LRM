 ...
 */
public class LRM_dynamic_schema {
    ...
    public static final OntProperty activationTime = m_model.createOntProperty( "http://xrce.xerox.com/LRM#activationTime" );
    
    /** <p>Indicates which activities is the subject of this activity-life dedicated 
     *  event</p>
     */
    public static final OntProperty activity = m_model.createOntProperty( "http://xrce.xerox.com/LRM#activity" );
    
    /** <p>the chunck will be statically analyzed, and all expansion will be realized 
     *  when possiblethe open variables are translated after unification with signaturedefines 
     *  the content of the module (uses the formal parameters defined in the signature)</p>
     */
    public static final OntProperty body = m_model.createOntProperty( "http://xrce.xerox.com/LRM#body" );
    
    /** <p>An event is triggered by an agent (therefore, by an acting entity)</p> */
    public static final OntProperty byAgent = m_model.createOntProperty( "http://xrce.xerox.com/LRM#byAgent" );
    
    /** <p>allows attaching descriptions of what the dependendy did change</p> */
    public static final OntProperty changed = m_model.createOntProperty( "http://xrce.xerox.com/LRM#changed" );
    
    /** <p>Indicates which resource(s) is(are) used while the activity is performed</p> */
    ...
    /** <p>Defines which triples of the resource have been deleted (the rdf:subject predicate 
     *  is defined by the lrm:subject one)</p>
     */
    public static final OntProperty deletion = m_model.createOntProperty( "http://xrce.xerox.com/LRM#deletion" );
    
    /** <p>used in addition to the lrm:subject property to indicate which other resources 
     *  are involved in the derivation process</p>
     */
    public static final OntProperty derivedFrom = m_model.createOntProperty( "http://xrce.xerox.com/LRM#derivedFrom" );
    
    public static final OntProperty desactivationTime = m_model.createOntProperty( "http://xrce.xerox.com/LRM#desactivationTime" );
    ...
    /** <p>Indicates which events were directly produced by the subject activity</p> */
    ...
    /** <p>Relates the activity to the agent(s) that execute it</p> */
    ...
    /** <p>Defines which triples of the resource have been inserted (the rdf:subject 
     *  predicate is defined by the lrm:subject one)</p>
     */
    public static final OntProperty insertion = m_model.createOntProperty( "http://xrce.xerox.com/LRM#insertion" );
    
    /** <p>specifies what must be always verified along the whole object life.also relates 
     *  to the so-called "significant properties" used in digital preservation.</p>
     */
    public static final OntProperty invariant = m_model.createOntProperty( "http://xrce.xerox.com/LRM#invariant" );
    
    /** <p>Indicates causal relationships between events</p> */
    public static final OntProperty isConsequenceOf = m_model.createOntProperty( "http://xrce.xerox.com/LRM#isConsequenceOf" );
    ...
    /** <p>Indicates which events were directly received by the subject activity</p> */
    public static final OntProperty received = m_model.createOntProperty( "http://xrce.xerox.com/LRM#received" );
    
    public static final OntProperty requestedService = m_model.createOntProperty( "http://xrce.xerox.com/LRM#requestedService" );
    
    /** <p>Indicates which activities were directly resumed by the appearance of the 
     *  subject event</p>
     */
    ...
    /** <p>This property is used to express the semantical properties of the resource: 
     *  it must be compatible with the invariant property attached to the resource, 
     *  if any.</p>
     */
    public static final OntProperty specifiedBy = m_model.createOntProperty( "http://xrce.xerox.com/LRM#specifiedBy" );
    
    /** <p>Indicates which activities were directly triggered by the appearance of the 
     *  subject event</p>
     */
    ...
    /** <p>Relates the activity to event(s) that triggered it</p> */
    ...
    /** <p>Indicates which plan is executed by the activity</p> */
    ...
    /** <p>allows defining modular constructs</p> */
    public static final OntClass Action = m_model.createClass( "http://xrce.xerox.com/LRM#Action" );
    
    /** <p>An activity is defined as the effect of the actions performed by some agent(s); 
     *  as such, it is a blackbox that can be observed and acharacterized through 
     *  its relationship with the flow of events that influenced it, and also trhough 
     *  the resources it used. Two particularly distinguished event classes mark the 
     *  active/inactive status of an activity: begining and termination through lrm:ActivityStarted 
     *  and lrm:ActivityStopped, as well as the suspension and resuming via lrm:ActivitySuspended 
     *  and lrm:ActivityResumed. An activity may involve other activities: this can 
     *  be captured by a specific usage of the lrm:used predicate that also applies 
     *  to any kind of resources. An activity can be described through a Plan description 
     *  (as in PROV)at various level of detail depending on the domain-specific needs. 
     *  The resources created, modified or deleted by an activity can be known on 
     *  the basis of the corresponding events it generated. Note also that an activity 
     *  can be either internal, i.e handled by the endogenous infrastructure to manage 
     *  dynamicity, or external, i.e. occuring in the ecosystem</p>
     */
    ...
    /** <p>This specific class of event deals with changes: these particular time instant 
     *  have a significance with respect to modifications of modeled resources (be 
     *  they endogenous or exogenous)also used to remember actions indertaken in order 
     *  to maintain the internal consistency of LRM instances (provenance)used to 
     *  trigger actions required in order to maintain the internal consistency of 
     *  LRM instances</p>
     */
    public static final OntClass ChangeEvent = m_model.createClass( "http://xrce.xerox.com/LRM#ChangeEvent" );
    
    /** <p>A new resource has been created; the lrm:subject designates the class of the 
     *  created resource</p>
     */
    public static final OntClass CreationEvent = m_model.createClass( "http://xrce.xerox.com/LRM#CreationEvent" );
    
    /** <p>Used to describe the differences between two resources</p> */
    ...
    /** <p>A new resource is created, on the basis of other known existing resource(s); 
     *  e.g. a copy operation, a merge, ...</p>
     */
    ...
    /** <p>A resource has been deleted</p> */
    public static final OntClass DestructionEvent = m_model.createClass( "http://xrce.xerox.com/LRM#DestructionEvent" );
    
    public static final OntClass EndogenousActivity = m_model.createClass( "http://xrce.xerox.com/LRM#EndogenousActivity" );
    
    /** <p>Event generated by the underlying system to track and process internal changes</p> */
    ...
    public static final OntClass EndogenousResource = m_model.createClass( "http://xrce.xerox.com/LRM#EndogenousResource" );
    
    /** <p>EndogenousEvent instances talk about Endogenous resources, whereas ExogenousEvent 
     *  instances talk about Exogenous resources. Note that both are Endogenous resources.</p>
     */
    ...
    /** <p>Event generated through explicit requests to signal changes that occured in 
    ...
    /** <p>A resource has been frozen: only descriptors can evolve</p> */
    public static final OntClass FreezeEvent = m_model.createClass( "http://xrce.xerox.com/LRM#FreezeEvent" );
    
    /** <p>allows defining actions which signature are dedicated to event handling (receive 
     *  the instanciated event IRI as input parameter)</p>
     */
    ...
    /** <p>used to send or receive information from services</p> */
    ...
    /** <p>used to model periodic events(max number of occurences may be bounded)</p> */
    ...
    /** <p>Used to express the semantical properties. could be a formal logical language, 
     *  a test-oriented prog. language, a formal or informal policy, a textual description...</p>
     */
    public static final OntClass Specification = m_model.createClass( "http://xrce.xerox.com/LRM#Specification" );
    
    public static final OntClass TemporalDescription = m_model.createClass( "http://xrce.xerox.com/LRM#TemporalDescription" );
    
    /** <p>NB: the nature of this transformation can be detailled through subclassing.A 
     *  resource is transformed in the ecosystem, meaning that the resource changed, 
     *  keeping the same identity</p>
     */
    public static final OntClass TransformationEvent = m_model.createClass( "http://xrce.xerox.com/LRM#TransformationEvent" );
    
    /** <p>The resource is updated (e.g. its digital extension changed), but no other 
     *  direct impact is observed yet on other resources</p>
     */
